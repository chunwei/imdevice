...
Description: Improves the UI for WordPress's built-in post formats. “文章类型选择器”显示跟美观.
Version: 0.2
...
class NV_Better_Formats {
    ...
    public static function enqueue_assets() {
        wp_enqueue_script('nv-bf-admin', plugin_dir_url(__FILE__) . 'assets/admin.js', array('jquery'), false, false);
