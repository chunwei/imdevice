			...
			<?php if( have_posts() ) : the_post(); ?>
				<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
					<div class="entry">
						...
						<?php wp_link_pages( array( 'before' => '<footer class="entry-utility"><p class="post-pagination">' . __( 'Pages:', 'pinboard' ), 'after' => '</p>本站收集和分享移动互联网及设备的最新信息，大部分内容来自互联网，版权归原作者所有，如不慎侵犯您的权利,请及时联系我们,我们将在第一时间予以更改或删除。</footer><!-- .entry-utility -->' ) ); ?>
					</div><!-- .entry -->
